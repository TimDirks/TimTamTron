...
module.exports = {
    name: 'compliment',
    description: 'Give another user a compliment to brighten their day.',
    args: true,
    usage: '[user]',
    execute(message) {
        ...
        if(member.id === message.author.id) {
            return message.channel.send("Isn't it a bit weird to compliment yourself, "+member.displayName+"?");
        }
